...
const intelligence = {
  ...
  activeRecommendation: {
    status: 'READY', localDate: '2026-09-13', fzRecommendedLane: 'ABSORB', confidence: 'MODERATE', recommendationVersion: 'test-rec-r1', shadowRecommendationId: 'shadow-test-r1', sessionOptionComposerVersion: '4.4.0-composer.1', sessionPrescriptionComposerVersion: '4.6.0-prescription.2',
