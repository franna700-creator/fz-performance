...
if(!fs.existsSync(htmlPath)||!fs.existsSync(cssPath)||!fs.existsSync(cleanJs)||!fs.existsSync(cleanCss)||!fs.existsSync(liveJs)||!fs.existsSync(liveCss)||!fs.existsSync(trainingSyncJs)||!fs.existsSync(trainingSyncCss))throw new Error('Clean shell inputs missing');
...
html=html
  ...
  .replace('<link href="/assets/app.css" rel="stylesheet"/>','<link href="/assets/app.css" rel="stylesheet"/><link href="/assets/clean.css" rel="stylesheet"/><link href="/assets/live-physiology.css" rel="stylesheet"/><link href="/assets/training-auto-sync.css" rel="stylesheet"/>')
  ...
  .replace('<script src="/assets/app.js" type="module"></script>','<script src="/assets/live-physiology.js" type="module"></script><script src="/assets/training-auto-sync.js" type="module"></script><script src="/assets/app-clean.js" type="module"></script>');
...
if(!html.includes('/assets/app-clean.js')||!html.includes('/assets/clean.css')||!html.includes('/assets/live-physiology.js')||!html.includes('/assets/live-physiology.css')||!html.includes('/assets/training-auto-sync.js')||!html.includes('/assets/training-auto-sync.css'))throw new Error('Clean runtime assets not wired');
...
console.log('PASS clean shell: neutral static HTML + runtime-owned TODAY/TRENDS/TRAIN/SYSTEM + Live Physiology + training auto-sync');
