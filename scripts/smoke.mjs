...
const checks=[
 ...
 ['canonical athlete memory',js.includes('FZ_TRANCHE3_ATHLETE_MEMORY_CONSOLIDATION_V1')&&js.includes('ATHLETE MEMORY · CANONICAL')&&css.includes('.fz-athlete-memory-shell')],
 ['athlete memory categories',['STATE','SESSION','COST','RECOVERY','FUELING','CONSTRAINT','HYPOTHESIS'].every(x=>js.includes(x))],
 ['athlete event date plus time',js.includes('fzAthleteMemoryStamp')&&js.includes('TIME NOT RETAINED')&&js.includes('day:\'2-digit\',month:\'short\',year:\'numeric\'' )],
 ['longitudinal voice derives from athlete memory',js.includes('Athlete Voice · derived from canonical Athlete Memory')&&js.includes('TRENDS no longer maintains a separate subjective-history list')&&js.includes('data-fz-open-athlete-memory')],
