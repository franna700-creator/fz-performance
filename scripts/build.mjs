...
// v0.6.0 PRODUCT RELEASE: Longitudinal Intelligence deepens the existing TRENDS surface.
// Runtime may later supply datasets.LONGITUDINAL; the embedded master-backed cohort is the safe initial fallback.
...
const DEFAULT_LONGITUDINAL={
  asOf:'07 Sep 2026',
  phase:'LONGITUDINAL INTELLIGENCE · ACTIVE',
  ...
  insights:{
    recovery:{confidence:'MODERATE',observation:'6 Sep closed with stress 44, sleep 4.73 h / score 31 and HRV 33. On 7 Sep, sleep rebounded to 7.78 h / 92, HRV to 81, RHR to 54 and Body Battery high to 94.',relationship:'The multi-signal disturbance reversed rapidly after a low-load day and strong overnight recovery.',feedback:'No contemporaneous 7 Sep local quad/gait check was available, so systemic recovery cannot substitute for local function.',interpretation:'This is early evidence of rapid recovery resilience rather than proof of a stable trait. The useful longitudinal question is how often a sharp disturbance normalises within 24–48 h and whether performance is preserved.',performance:'No matched quality session has yet validated the rebound as performance capacity.',watch:'Repeat the load → overnight response → athlete feeling → execution sequence across future disturbances.'},
...
const expected={'index.html':'cd5e9667b4e4c3007b335dea0911864830c845ddb2a9f5430b4103dc50a69f73','assets/app.css':'4c220f646f1e120745189488e322e54e8d92e884ef27506ab028851cadb9105e','assets/app.js':'9f89327d21bb50749fe2cbe10b0492cee44c11fe43c09d7d5f2c1fa3ecd1c6a5'};
