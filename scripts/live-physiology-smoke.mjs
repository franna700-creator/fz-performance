...
const checks = [
  ...
  ['persisted wellness still renders first', app.includes("getJson('/api/wellness/today?refresh=0')") && live.includes("requestUrl?.searchParams.get('refresh') === '0'") && live.includes('queueMicrotask(backgroundRefresh)')],
