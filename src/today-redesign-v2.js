...
const v2Observer=new MutationObserver(()=>{
  ...
  queueMicrotask(()=>{v2ClassifyQueued=false;const root=document.getElementById('today');if(!root)return;v2ClassifyLegacy(root);if(!root.querySelector(':scope > .fz2-shell')&&!FZ_TODAY_V2.busy)scheduleV2Load(30)});
});
