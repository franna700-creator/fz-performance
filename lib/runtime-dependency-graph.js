...
export const FZ_DEPENDENCY_GRAPH = Object.freeze({
  ...
  'athlete.memory':['measurement.evidence','process.reconcileAthleteMemory','recovery.current','readiness.current','training.identity','training.intent','performance.aet','capability.evidence','choice.outcome','materiality.current','adaptive.context','trends.summary','ui.train','ui.trends'],
