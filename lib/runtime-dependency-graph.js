...
export const FZ_DEPENDENCY_GRAPH = Object.freeze({
  ...
  'capability.evidence':['capability.priority','measurement.hierarchy','adaptive.context','ui.trends'],
  'capability.priority':['measurement.hierarchy','adaptive.context','recommendation.current','ui.trends'],
  'measurement.hierarchy':['adaptive.context','recommendation.current','recommendation.explanation','ui.trends'],

  'materiality.current':['adaptive.context','recommendation.current','ui.system'],
  'adaptive.context':['recommendation.current','ui.system'],
  'recommendation.current':['recommendation.explanation','adaptive.choice','ui.today'],
  'recommendation.explanation':['adaptive.choice','ui.today'],
