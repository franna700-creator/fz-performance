...
export const FZ_DEPENDENCY_GRAPH = Object.freeze({
  ...
  'source.system.reconciliation':['wellness.current','wellness.history','training.session','training.evidence','athlete.memory','athlete.state.current','objective.graph','measurement.evidence','materiality.current','readiness.current','adaptive.context','ui.system'],
  ...
  'wellness.history':['readiness.current','trends.summary','ui.trends'],
