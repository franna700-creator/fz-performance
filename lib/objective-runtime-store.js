...
export async function loadObjectiveBootstrapSeed(){return {objectiveRegistry:await json('../config/objective-seed.json'),formatRegistry:await json('../config/event-format-profiles.json')};}
