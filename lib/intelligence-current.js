...
export function buildIntelligenceCurrent(rows = {}) {
  ...
  const decisionMaterialityAt = firstValue(rows.decisionMateriality, ['ingested_at', 'source_updated_at']);
  ...
  const markers = {
    ...
    decisionMateriality: marker(rows.decisionMateriality, 'id', ['ingested_at', 'source_updated_at']),
