...
export function buildIntelligenceCurrent(rows = {}) {
  ...
  const decisionEvidenceAt = newest(runtimeAt, objectiveAt, decisionMaterialityAt);
  const pendingShadow = newer(decisionEvidenceAt, shadowAt) || !recoveryFreshnessPolicyCurrent;
